...
/**
 * The decorative scenery behind the pane and the progress card for a load or a save. The motion runs for everyone,
 * reduced-motion settings included (the owner's decision, 17 Sep 2026: slow and calm); there is no pause control.
 */
